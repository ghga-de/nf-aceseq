# ![nf-aceseq](docs/images/nf-core-aceseq_logo_light.png#gh-light-mode-only) ![nf-core/aceseq](docs/images/nf-core-aceseq_logo_dark.png#gh-dark-mode-only)
...
**nf-aceseq** is a bioinformatics best-practice analysis pipeline for ACEseq Allele-specific copy number estimation with whole genome sequencing ODCF pipeline.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```bash
   nextflow run nf-aceseq -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run nf-aceseq --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```
